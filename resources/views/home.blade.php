        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
                        ...
                        <!--begin::Logo-->
                        <a href="{{ url('../../demo39/dist/index.html') }}" class="app-sidebar-logo">
                            <img alt="Logo" src="{{ asset('/assets/media/logos/demo39.svg') }}"
                        ...
                        <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                            ...
                            <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px"
                                ...
                                <form data-kt-search-element="form"
                                    ...
                                    <!--begin::Input-->
                                    <input type="text"
                                        class="search-input form-control form-control border-0 h-lg-45px ps-13"
                                ...
                                <div data-kt-search-element="content"
                                    ...
                                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="{{ url('../../demo39/dist/pages/search/horizontal.html') }}"
                                    ...
                                    <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                        <li class="nav-item">
                                            <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                                data-bs-toggle="tab"
                                                href="{{ url('#kt_topbar_notifications_1') }}">Alerts</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active"
                                                data-bs-toggle="tab"
                                                href="{{ url('#kt_topbar_notifications_2') }}">Updates</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                                data-bs-toggle="tab"
                                                href="{{ url('#kt_topbar_notifications_3') }}">Logs</a>
                                        </li>
                                    </ul>
                                    <!--end::Tabs-->
                                </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                        ...
                                        <div class="py-3 text-center border-top">
                                            <a href="{{ url('../../demo39/dist/pages/user-profile/activity.html') }}"
                                        ...
                                        <div class="d-flex flex-column px-9">
                                            ...
                                            <div class="pt-10 pb-0">
                                                ...
                                                <div class="text-center mt-5 mb-9">
                                                    <a href="{{ url('#') }}" class="btn btn-sm btn-primary px-6"
                        ...
                        <div class="app-navbar-item ms-2 ms-lg-6">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                ...
                                <div class="row g-0">
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ url('../../demo39/dist/apps/projects/budget.html') }}"
                                    ...
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ url('../../demo39/dist/apps/projects/settings.html') }}"
                                    ...
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ url('../../demo39/dist/apps/projects/list.html') }}"
                                    ...
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ url('../../demo39/dist/apps/projects/users.html') }}"
                        ...
                        <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-5">
                                    <a href="{{ url('../../demo39/dist/account/overview.html') }}"
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ url('../../demo39/dist/account/referrals.html') }}"
                                                class="menu-link px-5">Referrals</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ url('../../demo39/dist/account/billing.html') }}"
                                                class="menu-link px-5">Billing</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ url('../../demo39/dist/account/statements.html') }}"
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                                        ...
                                        <div class="menu-item px-3 my-0">
                                            <a href="{{ url('#') }}" class="menu-link px-3 py-2"
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ url('../../demo39/dist/account/settings.html') }}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="{{ url('../../demo39/dist/authentication/layouts/corporate/sign-in.html') }}"
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <!--begin::Wrapper-->
                    <div id="kt_app_sidebar_wrapper" class="app-sidebar-wrapper hover-scroll-y my-5 my-lg-2"
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link active"
                                            href="{{ url('../../demo39/dist/index.html') }}">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="{{ url('../../demo39/dist/dashboards/ecommerce.html') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="{{ url('../../demo39/dist/dashboards/projects.html') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="{{ url('../../demo39/dist/dashboards/online-courses.html') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="{{ url('../../demo39/dist/dashboards/marketing.html') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-inner flex-column collapse"
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/bidding.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/pos.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/call-center.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/logistics.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/website-analytics.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/finance-performance.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/store-analytics.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/social.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/delivery.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/crypto.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/school.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/dashboards/podcast.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link"
                                                href="{{ url('../../demo39/dist/landing.html') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                    ...
                                    <div class="menu-item">
                                        <div class="menu-content">
                                            <a class="btn btn-flex btn-color-primary d-flex flex-stack fs-base p-0 ms-2 mb-2 toggle collapsible collapsed"
                                                ...
                                                href="{{ url('#kt_app_sidebar_menu_dashboards_collapse') }}"
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/user-profile/overview.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/user-profile/projects.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Projects</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/user-profile/campaigns.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/user-profile/documents.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/user-profile/followers.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/user-profile/activity.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/overview.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Overview</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/settings.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/security.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/activity.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Activity</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/billing.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/statements.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/referrals.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/api-keys.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/account/logs.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/corporate/sign-in.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/corporate/sign-up.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/corporate/two-factor.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/corporate/reset-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/corporate/new-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/overlay/sign-in.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-in</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/overlay/sign-up.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-up</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/overlay/two-factor.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Two-Factor</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/overlay/reset-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/overlay/new-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">New Password</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/creative/sign-in.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-in</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/creative/sign-up.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-up</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/creative/two-factor.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Two-Factor</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/creative/reset-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/creative/new-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">New Password</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/fancy/sign-in.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-in</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/fancy/sign-up.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sign-up</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/fancy/two-factor.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Two-Factor</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/fancy/reset-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/layouts/fancy/new-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">New Password</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/email/welcome-message.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/email/reset-password.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Reset Password</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/email/subscription-confirmed.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/email/card-declined.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/email/promo-1.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/email/promo-2.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/authentication/email/promo-3.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/extended/multi-steps-sign-up.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/general/welcome.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Welcome Message</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/general/verify-email.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/general/coming-soon.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/general/password-confirmation.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/general/account-deactivated.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/general/error-404.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/authentication/general/error-500.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/about.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/team.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/contact.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/licenses.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/sitemap.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/social/feeds.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/social/activity.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/social/followers.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Followers</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/social/settings.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/blog/home.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/blog/post.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/faq/classic.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/faq/extended.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/pricing/column.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/pricing/table.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/careers/list.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/pages/careers/apply.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/widgets/lists.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/widgets/statistics.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/widgets/charts.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/widgets/mixed.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/widgets/tables.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/widgets/feeds.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Feeds</span>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/list.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/project.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/targets.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/budget.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/users.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/files.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/activity.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Activity</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/projects/settings.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/catalog/products.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/catalog/categories.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/catalog/add-product.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/catalog/edit-product.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/catalog/add-category.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/catalog/edit-category.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/sales/listing.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/sales/details.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/sales/add-order.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/sales/edit-order.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/customers/listing.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/customers/details.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/reports/view.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/reports/sales.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Sales</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/reports/returns.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/reports/customer-orders.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/ecommerce/reports/shipping.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/ecommerce/settings.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/contacts/getting-started.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/contacts/add-contact.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/contacts/edit-contact.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/contacts/view-contact.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/support-center/overview.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Overview</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/support-center/tickets/list.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/support-center/tickets/view.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/support-center/tutorials/list.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/support-center/tutorials/post.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/support-center/faq.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">FAQ</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/support-center/licenses.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Licenses</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/support-center/contact.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Contact Us</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/user-management/users/list.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/user-management/users/view.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/user-management/roles/list.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/user-management/roles/view.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/user-management/permissions.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/customers/getting-started.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Getting Started</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/customers/list.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Customer Listing</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/customers/view.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Customer Details</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/subscriptions/getting-started.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Getting Started</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/subscriptions/list.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/subscriptions/add.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/subscriptions/view.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/invoices/view/invoice-1.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/invoices/view/invoice-2.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/apps/invoices/view/invoice-3.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/invoices/create.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/file-manager/folders.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/file-manager/files.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Files</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/file-manager/blank.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/file-manager/settings.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Settings</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/inbox/listing.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/inbox/compose.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/inbox/reply.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/chat/private.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/chat/group.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/apps/chat/drawer.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link"
                                            href="{{ url('../../demo39/dist/apps/calendar.html') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/general/invite-friends.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/general/view-users.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/general/select-users.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/general/upgrade-plan.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/general/share-earn.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/forms/new-target.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/forms/new-card.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/forms/new-address.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/forms/create-api-key.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/forms/bidding.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Bidding</span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/wizards/create-app.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/wizards/create-campaign.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/wizards/create-account.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/wizards/create-project.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/wizards/top-up-wallet.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/wizards/offer-a-deal.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/wizards/two-factor-authentication.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                            ...
                                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                ...
                                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/search/users.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                                            <span class="menu-title">Users</span>
                                                    ...
                                                    <div class="menu-item">
                                                        <!--begin:Menu link-->
                                                        <a class="menu-link"
                                                            href="{{ url('../../demo39/dist/utilities/modals/search/select-location.html') }}">
                                                            <span class="menu-bullet">
                                                                <span class="bullet bullet-dot"></span>
                                                            </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/horizontal.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/vertical.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/two-factor-authentication.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Two Factor Auth</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/create-app.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Create App</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/create-campaign.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Create Campaign</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/create-account.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/create-project.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Create Project</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/wizards/offer-a-deal.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Offer a Deal</span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/search/horizontal.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Horizontal</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/search/vertical.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Vertical</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/search/users.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Users</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link"
                                                    href="{{ url('../../demo39/dist/utilities/search/select-location.html') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                        ...
                        <div class="app-sidebar-menu-secondary menu menu-rounded menu-column ps-5 pe-6">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link menu-collapse-toggle toggle collapsible collapsed"
                                    data-bs-toggle="collapse"
                                    href="{{ url('#kt_app_sidebar_menu_projects_collapse') }}"
                                    data-kt-toggle-text="Show less">
                                    <span class="menu-icon ps-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="symbol-group symbol-hover flex-nowrap">
                                                            ...
                                                            <div class="symbol symbol-35px symbol-circle"
                                                                ...
                                                                <img alt="Pic"
                                                                    src="{{ asset('/assets/media/avatars/300-11.jpg') }}" />
                                                            </div>
                                                            <div class="symbol symbol-35px symbol-circle"
                                            ...
                                            <div class="card-body d-flex flex-column flex-center">
                                                ...
                                                <div class="text-center mb-1">
                                                    ...
                                                    <a class="btn btn-sm btn-primary me-2"
                                                        href="{{ url('../../demo39/dist/apps/ecommerce/customers/listing.html') }}">Try
                                                        now</a>
                                                    <!--end::Link-->
                                                    <!--begin::Link-->
                                                    <a class="btn btn-sm btn-light"
                                                        href="{{ url('../../demo39/dist/apps/invoices/view/invoice-1.html') }}">Learn
                                                        more</a>
                                                    <!--end::Link-->
                                                </div>
                                                <!--end::Links-->
                                            ...
                                            <div class="card-header flex-nowrap pt-5">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ url('#') }}"
                                                                class="menu-link px-3">New Ticket</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ url('#') }}"
                                                                class="menu-link px-3">New Customer</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3" data-kt-menu-trigger="hover"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ url('#') }}"
                                                                class="menu-link px-3">New Contact</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu separator-->
                                    ...
                                    <div class="col-xl-4 mb-5 mb-xl-10">
                                        ...
                                        <div class="card card-flush h-md-100">
                                            ...
                                            <div class="card-header pt-7">
                                                ...
                                                <!--begin::Toolbar-->
                                                <div class="card-toolbar">
                                                    <a href="{{ url('../../demo39/dist/apps/ecommerce/catalog/categories.html') }}"
                                                    ...
                                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="ps-0">
                                                                    <a href="{{ url('../../demo39/dist/apps/ecommerce/sales/details.html') }}"
                                    ...
                                    <div class="col-xl-4 mb-xl-10">
                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-header pt-7 mb-5">
                                                ...
                                                <!--begin::Toolbar-->
                                                <div class="card-toolbar">
                                                    <a href="{{ url('../../demo39/dist/apps/ecommerce/sales/listing.html') }}"
                                                        class="btn btn-sm btn-light">View All</a>
                                                </div>
                                                <!--end::Toolbar-->
                                            </div>
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="{{ asset('/assets/media/flags/brazil.svg') }}"
                                                            class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        <!--begin::Section-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="{{ asset('/assets/media/flags/turkey.svg') }}"
                                                            class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        <!--begin::Section-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="{{ asset('/assets/media/flags/france.svg') }}"
                                                            class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        <!--begin::Section-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="{{ asset('/assets/media/flags/india.svg') }}"
                                                            class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        <!--begin::Section-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        <!--begin::Flag-->
                                                        <img src="{{ asset('/assets/media/flags/sweden.svg') }}"
                                                            class="me-4 w-25px" style="border-radius: 4px"
                                                            alt="" />
                                                        <!--end::Flag-->
                                                        <!--begin::Section-->
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-30px me-5">
                                                            <span class="symbol-label">
                                                                <i
                                                                    class="ki-outline ki-rocket fs-3 text-gray-600"></i>
                                                            </span>
                                                        </div>
                                                        <!--end::Symbol-->
                                                        <!--begin::Container-->
                                                    ...
                                                    <div class="text-center pt-8 d-1">
                                                        <a href="{{ url('../../demo39/dist/apps/ecommerce/sales/details.html') }}"
                                                            ...
                                                            Store Analytics
                                                            <i
                                                                class="ki-outline ki-arrow-right fs-3 text-primary"></i></a>
                                                    </div>
                                                    <!--end::Link-->
                                                </div>
                                                <!--end::Wrapper-->
                ...
                <div id="kt_app_aside" class="app-aside flex-column" data-kt-drawer="true"
                    ...
                    <div id="kt_app_aside_wrapper"
                        ...
                        <a href="{{ url('../../demo39/dist/apps/calendar.html') }}"
                        ...
                        <a href="{{ url('../../demo39/dist/apps/ecommerce/catalog/products.html') }}"
                        ...
                        <a href="{{ url('../../demo39/dist/apps/inbox/listing.html') }}"
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <a href="{{ url('../../demo39/dist/apps/projects/project.html') }}"
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="overflow-auto pb-5">
                                        ...
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            ...
                                            <!--end::Info-->
                                            <!--begin::User-->
                                            <a href="{{ url('#') }}" class="text-primary fw-bold me-1">Alice
                                                Tan</a>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Wrapper-->
                            ...
                            <div class="timeline-content mt-n1">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <!--end::Info-->
                                        <!--begin::User-->
                                        <a href="{{ url('#') }}" class="text-primary fw-bold me-1">Jimmy
                                            Bold</a>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="me-0">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ url('#') }}" class="menu-link px-3" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_users_search">Add Contact</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ url('#') }}" class="menu-link flex-stack px-3"
                                    data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Invite Contacts
                                    <span class="ms-2" data-bs-toggle="tooltip"
                            ...
                            <div class="menu-item px-3" data-kt-menu-trigger="hover"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ url('#') }}" class="menu-link px-3"
                                            data-bs-toggle="tooltip" title="Coming soon">Create Group</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ url('#') }}" class="menu-link px-3"
                                            data-bs-toggle="tooltip" title="Coming soon">Invite Members</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ url('#') }}" class="menu-link px-3"
                                            data-bs-toggle="tooltip" title="Coming soon">Settings</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu sub-->
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3 my-1">
                                <a href="{{ url('#') }}" class="menu-link px-3" data-bs-toggle="tooltip"
        ...
        <div class="card card-flush w-100 rounded-0">
            ...
            <div class="card-footer">
                ...
                <div class="d-flex justify-content-end mt-9">
                    <a href="{{ url('#') }}" class="btn btn-primary d-flex justify-content-end">Pleace
                        Order</a>
                </div>
                <!--end::Action-->
            </div>
                ...
                <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                    ...
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">If you need more info, please check
                            <a href="{{ url('#') }}" class="link-primary fw-bold">Pricing Guidelines</a>.
                        </div>
                    </div>
                    <!--end::Heading-->
                    <!--begin::Plans-->
                            ...
                            <div class="col-lg-6 mb-10 mb-lg-0">
                                ...
                                <div class="nav flex-column">
                                    ...
                                    <label
                                        ...
                                        <!--begin::Price-->
                                        <div class="ms-5">
                                            <a href="{{ url('#') }}" class="btn btn-sm btn-success">Contact
                                                Us</a>
                                        </div>
                                        <!--end::Price-->
                                    </label>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="text-center mb-13">
                        ...
                        <div class="text-muted fw-semibold fs-5">If you need more info, please check out our
                            <a href="{{ url('#') }}" class="link-primary fw-bold">Users Directory</a>.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="text-center mb-13">
                        ...
                        <div class="text-muted fw-semibold fs-5">If you need more info, please check out
                            <a href="{{ url('#') }}" class="link-primary fw-bold">FAQ Page</a>.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
